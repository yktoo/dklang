///*********************************************************************************************************************
///  $Id: DKL_ResFile.pas 2013-12-06 00:00:00Z bjm $
///---------------------------------------------------------------------------------------------------------------------
...
type
  ...
  TDKLang_ResEntries = TObjectList<TDKLang_ResEntry>;

  TDKLang_ResFile = class(TObject)
  private
     // Entry list
    FEntries: TDKLang_ResEntries;
...
implementation
  ...
  begin
    inherited Create;
    FEntries := TDKLang_ResEntries.Create;
  end;
    ...
    begin
      ...
      if (wsType<>'0') or (wsName<>'0') then begin
        ...
        try
          ...
          p := pData;
          Inc(p,Header.iHeaderSize);
          SetLength(sRawData,Header.iDataSize);
          Move(p^, sRawData[0], Header.iDataSize);
